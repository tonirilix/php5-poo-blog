...
(function($) {
  ...
  $.extend($.popupbox, {
    settings: {
      opacity      : 0.5,
      overlay      : true,
      loadingImage : 'jquerytgz/componentes/popupbox/loading.gif',
      closeImage   : 'jquerytgz/componentes/popupbox/closelabel.gif',
      ...
      <div class="popup">\
        <table>\
          <tbody>\
            <tr>\
              <td class="tl"/><td class="tc"/><td class="tr"/>\
            </tr>\
            <tr>\
              <td class="ml"/>\
              <td class="body">\
			  	<div class="header">\
                	<a href="#" class="close"> \
                  		<img src="" title="Cerrar Ventana" class="close_image" onClick="as();"/> \
                	</a> \
                </div>\
    ...
    loading: function() {
      ...
      showOverlay()
      $('#popupbox #popupboxcontent').empty()
